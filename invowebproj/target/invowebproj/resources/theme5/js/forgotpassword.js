...
$scope.submitForm = function () {
	...
	$scope.testObj= [{"userId":"userId1","type":"type1"},{"userId":"userId1","type":"type1"}];//, { name: "Eveear", id: 2 }, { name: "HCL", id: 3 }];
	...
	$http({
    	...
    	else
    	{
    		...
    		$scope.testObj=angular.fromJson(data.data.testObj);
    		alert(angular.toJson(data.data.testObj));
    	}
    },
    function(error){
    	//alert("Please correct errors!");
